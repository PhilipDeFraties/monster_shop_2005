  ...
  describe 'when I am logged in' do
    ...
    describe 'as a default user' do
      ...
      it "I also see a logged in text with the user's name" do
        ...
        expect(page).to have_content('Logged in as Warren Buffet')
      end
      ...
      it 'If I try to go to /login I am redirected to my profile with a already logged in flash message' do
        visit '/login'
    ...
    describe "as a merchant employee" do
      ...
      it 'If I try to go to /login I am redirected to my merchant dashboard with a already logged in flash message' do
        visit '/login'
    ...
    describe "As an admin" do
      ...
      it 'If I try to go to /login I am redirected to my admin dashboard with a already logged in flash message' do
        visit '/login'
