    ...
    describe "As any kind of user on the system" do
      ...
      describe "When I visit the items index page" do
        it "I see the top 5 most popular items by quantity purchased, plus the quantity bought" do
          ...
          item_order9 = ItemOrder.create!(order: order_2, item: frisbee, price: 21, quantity: 2)
          ...
          item_order13 = ItemOrder.create!(order: order_2, item: pull_toy, price: 21, quantity: 2)
          ...
          within '#most-popular-items' do
            ...
            expect(page).to have_content("Frisbee: 4")
            expect(page).to have_content("Pull Toy: 3")
          end
